...
public class UpvoteFacadeREST extends AbstractFacade<Upvote> {
    ...
    @Produces({"application/xml", "application/json"})
    public List<Upvote> findUpvote(@PathParam("idUser") Integer idUser,@PathParam("idPost") Integer idPost){
        return  em.createQuery(
                     "SELECT c FROM Upvote c WHERE c.idUser.idUser =:idUser AND c.idPost.idPost=:idPost")
